...
function PropertyDetailsPage() {
  ...
  const ownerPhone = pickString(owner, 'phone', 'phoneNumber') || pickString(property ?? undefined, 'ownerPhone', 'phone', 'phoneNumber');
  const ownerPhoneDigits = ownerPhone ? ownerPhone.replace(/\D/g, '') : '';
                      ...
                      <div className="flex flex-col gap-4">
                        ...
                        {ownerPhoneDigits ? (
                          <div className="flex items-center gap-2">
                            <a
                              href={`tel:+${ownerPhoneDigits}`}
                              className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-full text-sm font-semibold text-[#1D242B] bg-[#FCC519] hover:bg-[#f0bb0e] transition-colors"
                            >
                              <Phone className="w-4 h-4" />
                              {t('addListing.propertyDetails.call')}
                            </a>
                            <a
                              href={`https://wa.me/${ownerPhoneDigits}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              aria-label={t('addListing.propertyDetails.whatsapp')}
                              title={t('addListing.propertyDetails.whatsapp')}
                              className="inline-flex items-center justify-center w-11 h-11 rounded-full text-white bg-[#25D366] hover:bg-[#1ebe5b] transition-colors flex-shrink-0"
                            >
